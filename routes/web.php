...
Route::get('/candidatos/crear', [CandidatosController::class, 'crear']);
Route::post('/candidatos/guardar', [CandidatosController::class, 'guardar']);
Route::get('/candidatos/{candidato}', [CandidatosController::class, 'buscar']);
Route::get('/candidatos/{id}/modificar', [CandidatosController::class, 'modificar']);
Route::put('/candidatos/{id}/actualizar', [CandidatosController::class, 'actualizar']);
Route::delete('/candidatos/{id}/eliminar', [CandidatosController::class, 'eliminar']);
...
Route::get('/ofertaLaboral', [ofertaLaboralController::class, 'index']);
Route::get('/ofertaLaboral/crear', [ofertaLaboralController::class, 'crear']);
Route::post('/ofertaLaboral/guardar', [ofertaLaboralController::class, 'guardar']);
Route::get('/ofertaLaboral/{id}', [ofertaLaboralController::class, 'buscar']);
Route::get('/ofertaLaboral/{id}/modificar', [ofertaLaboralController::class, 'modificar']);
Route::put('/ofertaLaboral/{id}/actualizar', [ofertaLaboralController::class, 'actualizar']);
Route::delete('/ofertaLaboral/{id}/eliminar', [ofertaLaboralController::class, 'eliminar']);
...
Route::get('/nomina/crear', [nominaController::class, 'crear']);
Route::post('/nomina/guardar', [nominaController::class, 'guardar']);
Route::get('/nomina/{id}', [nominaController::class, 'buscar']);
Route::get('/nomina/{id}/modificar', [nominaController::class, 'modificar']);
Route::put('/nomina/{id}/actualizar', [nominaController::class, 'actualizar']);
Route::delete('/nomina/{id}/eliminar', [nominaController::class, 'eliminar']);
