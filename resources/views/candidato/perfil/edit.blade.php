...
@section('content')
    <div class="container">
        <h2 class="section-heading">Editar Perfil de Candidato</h2>
        <hr class="hr-divider">
        <div class="card"> {{-- Un único recuadro (card) para los dos formularios principales --}}
            <div class="form-grid cols-2"> {{-- Contenedor para distribuir los dos formularios en 2 columnas --}}
                <div class="card">
        ...
        </div> {{-- Cierre del único recuadro (card) --}}
